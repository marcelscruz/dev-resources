...
export const resources: Resource[] = [
    ...
    },
    {
        name: 'Default Alive',
        description:
            'Two founders share an unedited look at what it\',
    ...
    },
    {
        name: 'Doodlicons',
        description:
            'Over 700 hand-drawn vector design elements.',
    ...
    },
    {
        name: 'DreamStudio',
        description:
            'DreamStudio is an online creative tool to generate images with AI. Made by the world',
        categories: ['AI', 'Image'],

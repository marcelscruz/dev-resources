...
export const resources: Resource[] = [
    ...
    },
    {
        name: 'IconVectors',
        description:
            'Desktop SVG icon editor for developers with visual editing, icon management, batch processing, code export, and MCP automation.',
        categories: ['Icon', 'Editor', 'Tooling'],

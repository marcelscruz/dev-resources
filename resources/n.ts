...
export const resources: Resource[] = [
    ...
    {
        name: 'NanoCloud',
        description: 'NanoCloud is a browser-based AI image generator and editor for creating polished visuals from text prompts and reference images.',
        categories: ['AI', 'Design'],
        url: 'https://nanobananapro.cloud/',
        keywords: ['AI image generation', 'image editing', 'text-to-image', 'API'],
    },
    {
        name: 'Narrow AI',
        description:

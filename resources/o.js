module.exports = [
    ...
    },
    {
        name: 'OnlineWebFonts',
        description:
            'Free SVG icons download, there are more than 200 000 SVG (PNG,PSD,EPS,PNM) creative, you can download on demand, you can also download package, quick search function to help you quickly find favorite SVG icons.',
        keywords: [
            'SVG icon',
            'svg vector icons',
            'png icon',
    ...
    {
        name: 'OnlineWebFonts',
        keywords: ['Best Fonts', 'Free Best Fonts', 'Top Free Font', 'Best Font Download', 'Top Best Font Dwonload'],

...
const warning =
    '>❗️ This README file is auto-generated on every `push` and/or `merge`, so please **do not** edit it. Changes related to resources should happen within the `/resources` folder.\n\n'
